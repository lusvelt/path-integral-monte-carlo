...
def compute_path_integral_average_bootstrap (functional: Callable, S_per_component:Callable ,N: int, N_cf: int, N_cor: int, eps: float, thermalization_its: int=5): 
    """
    Computes the path integral average and the standard deviation of a functional obtained using the bootstrap procedure.
